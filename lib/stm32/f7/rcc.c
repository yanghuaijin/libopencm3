...
{
	uint32_t reg32 = RCC_DCKCFGR1;
	reg32 &= ((RCC_DCKCFGR1_PLLSAIDIVR_MASK << RCC_DCKCFGR1_PLLSAIDIVR_SHIFT)
		| (RCC_DCKCFGR1_PLLSAIDIVQ_MASK << RCC_DCKCFGR1_PLLSAIDIVQ_SHIFT));
	RCC_DCKCFGR1 = reg32 | ((q << RCC_DCKCFGR1_PLLSAIDIVQ_SHIFT) |
		(r << RCC_DCKCFGR1_PLLSAIDIVR_SHIFT));
}
